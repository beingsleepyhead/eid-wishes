...
function setRef(rawRef, oldRawRef, parentSuspense, vnode, isUnmount = false) {
  ...
  if (isFunction(ref2)) {
    ...
    const _isString3 = isString(ref2);
    const _isRef = /* @__PURE__ */ isRef(ref2);
    if (_isString3 || _isRef) {
      const doSet = () => {
        if (rawRef.f) {
          const existing = _isString3 ? canSetSetupRef(ref2) ? setupState[ref2] : refs[ref2] : canSetRef() || !rawRef.k ? ref2.value : refs[rawRef.k];
          if (isUnmount) {
...
var _addComplexStringPropTween = function _addComplexStringPropTween2(target, prop, start, end, setter, stringFilter, funcParam) {
  ...
  var vars = tween.vars, ease = vars.ease, startAt = vars.startAt, immediateRender = vars.immediateRender, lazy = vars.lazy, onUpdate = vars.onUpdate, runBackwards = vars.runBackwards, yoyoEase = vars.yoyoEase, keyframes = vars.keyframes, autoRevert = vars.autoRevert, dur = tween._dur, prevStartAt = tween._startAt, targets = tween._targets, parent = tween.parent, fullTargets = parent && parent.data === "nested" ? parent.vars.targets : targets, autoOverwrite = tween._overwrite === "auto" && !_suppressOverwrites, tl = tween.timeline, reverseEase = vars.easeReverse || yoyoEase, cleanVars, i, p2, pt, target, hasPriority, gsData, harness, plugin, ptLookup, index, harnessVars, overwritten;
...
const AnimatedBackground_vue_vue_type_style_index_0_scoped_6d186e9b_lang = "";
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    const bgContainer = /* @__PURE__ */ ref(null);
    onMounted(() => {
      const elements = bgContainer.value.querySelectorAll(".geometric-element");
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createStaticVNode('<svg class="geometric-pattern" viewBox="0 0 1200 800" preserveAspectRatio="xMidYMid slice" data-v-6d186e9b><line x1="0" y1="100" x2="1200" y2="100" stroke="#000" stroke-width="1" opacity="0.1" data-v-6d186e9b></line><line x1="0" y1="200" x2="1200" y2="200" stroke="#000" stroke-width="1" opacity="0.08" data-v-6d186e9b></line><g class="geometric-element" opacity="0.15" data-v-6d186e9b><circle cx="100" cy="200" r="40" fill="none" stroke="#000" stroke-width="2" data-v-6d186e9b></circle><circle cx="100" cy="200" r="25" fill="none" stroke="#000" stroke-width="1" data-v-6d186e9b></circle></g><g class="geometric-element" opacity="0.15" data-v-6d186e9b><circle cx="1100" cy="600" r="35" fill="none" stroke="#000" stroke-width="2" data-v-6d186e9b></circle><circle cx="1100" cy="600" r="20" fill="none" stroke="#000" stroke-width="1" data-v-6d186e9b></circle></g><line x1="600" y1="0" x2="600" y2="800" stroke="#000" stroke-width="0.5" opacity="0.05" data-v-6d186e9b></line><line x1="0" y1="750" x2="1200" y2="750" stroke="#000" stroke-width="1" opacity="0.1" data-v-6d186e9b></line><g opacity="0.12" data-v-6d186e9b><polygon points="50,50 100,50 75,100" fill="none" stroke="#000" stroke-width="1" data-v-6d186e9b></polygon><polygon points="1150,750 1100,750 1125,700" fill="none" stroke="#000" stroke-width="1" data-v-6d186e9b></polygon></g></svg>', 1)
      ])], 512);
    };
  }
};
const AnimatedBackground = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-6d186e9b"]]);
const ParticleField_vue_vue_type_style_index_0_scoped_844b7a2c_lang = "";
const _sfc_main$4 = {
...
const ParticleField = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-844b7a2c"]]);
const AnimatedCrescent_vue_vue_type_style_index_0_scoped_4d79dccd_lang = "";
const _sfc_main$3 = {
  __name: "AnimatedCrescent",
  setup(__props) {
    const crescentContainer = /* @__PURE__ */ ref(null);
    onMounted(() => {
      const crescentGroup = crescentContainer.value.querySelector(".crescent-group");
      crescentContainer.value.querySelector(".stars-group");
      const stars = crescentContainer.value.querySelectorAll(".star");
      gsapWithCSS.to(crescentGroup, {
        y: 20,
        duration: 4,
        repeat: -1,
        yoyo: true,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: "crescent-container",
        ref_key: "crescentContainer",
        ref: crescentContainer
      }, [..._cache[0] || (_cache[0] = [
        createStaticVNode('<svg class="crescent-svg" viewBox="0 0 200 200" width="150" height="150" data-v-4d79dccd><g class="crescent-group" data-v-4d79dccd><circle cx="100" cy="100" r="80" fill="#000" data-v-4d79dccd></circle><circle cx="115" cy="85" r="80" fill="#fff" data-v-4d79dccd></circle></g><g class="stars-group" data-v-4d79dccd><circle class="star" cx="50" cy="40" r="3" fill="#000" data-v-4d79dccd></circle><circle class="star" cx="150" cy="50" r="2.5" fill="#000" data-v-4d79dccd></circle><circle class="star" cx="160" cy="130" r="2" fill="#000" data-v-4d79dccd></circle><circle class="star" cx="40" cy="160" r="2.5" fill="#000" data-v-4d79dccd></circle></g></svg>', 1)
      ])], 512);
    };
  }
};
const AnimatedCrescent = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-4d79dccd"]]);
const EidGreeting_vue_vue_type_style_index_0_scoped_1243d11e_lang = "";
const _hoisted_1$1 = { class: "name-highlight" };
const _sfc_main$2 = {
  __name: "EidGreeting",
  props: {
    name: {
  ...
  setup(__props) {
    const greetingContainer = /* @__PURE__ */ ref(null);
    const greetingText = /* @__PURE__ */ ref(null);
    const arabicGreeting = /* @__PURE__ */ ref(null);
    const subtitle = /* @__PURE__ */ ref(null);
    onMounted(() => {
      ...
      gsapWithCSS.to(greetingText.value, {
        letterSpacing: 2,
        duration: 2.5,
        delay: 1.8,
        repeat: -1,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        ref_key: "greetingContainer",
        ref: greetingContainer
      }, [
        createBaseVNode("h1", {
          class: "greeting-text",
          ref_key: "greetingText",
          ref: greetingText
        }, "Eid Al-Adha Mubarak", 512),
        createBaseVNode("div", {
          class: "arabic-greeting",
          ref_key: "arabicGreeting",
          ref: arabicGreeting
        }, "عيد الأضحى مبارك", 512),
        createBaseVNode("p", {
          class: "subtitle",
          ref_key: "subtitle",
          ref: subtitle
        }, [
          _cache[0] || (_cache[0] = createTextVNode("To ", -1)),
          createBaseVNode("span", _hoisted_1$1, toDisplayString(__props.name), 1)
        ], 512)
      ], 512);
    };
  }
};
const EidGreeting = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-1243d11e"]]);
const PersonalMessage_vue_vue_type_style_index_0_scoped_dbab0d0a_lang = "";
const _sfc_main$1 = {
  __name: "PersonalMessage",
  setup(__props) {
    const messageContainer = /* @__PURE__ */ ref(null);
    const messageText = /* @__PURE__ */ ref(null);
    const decorativeLine = /* @__PURE__ */ ref(null);
    const closing = /* @__PURE__ */ ref(null);
    onMounted(() => {
      const tl = gsapWithCSS.timeline({ delay: 0.5 });
      tl.from(messageText.value, {
        opacity: 0,
        y: 20,
        duration: 0.8,
        ease: "power3.out"
      }, 0);
      tl.from(decorativeLine.value, {
        scaleX: 0,
        opacity: 0,
        duration: 0.6,
        ease: "power2.out"
      }, 0.3);
      tl.from(closing.value, {
        opacity: 0,
        y: 15,
        duration: 0.6,
        ease: "power3.out"
      }, 0.6);
      gsapWithCSS.to(closing.value, {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("p", { class: "main-message" }, "Wishing you a joyful Eid filled with love, happiness, and countless blessings.", -1),
          createBaseVNode("p", { class: "secondary-message" }, "May this special day bring you closer to your loved ones and fill your heart with joy.", -1)
        ])], 512),
        createBaseVNode("div", {
          class: "decorative-line",
          ref_key: "decorativeLine",
          ref: decorativeLine
        }, null, 512),
        createBaseVNode("div", {
          class: "closing",
          ...
          createBaseVNode("p", { class: "closing-text" }, "Eid Mubarak!", -1)
        ])], 512)
      ], 512);
    };
  }
};
const PersonalMessage = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-dbab0d0a"]]);
...
const App_vue_vue_type_style_index_0_scoped_733f5ff2_lang = "";
const _hoisted_1 = { class: "app-container" };
const _hoisted_2 = { class: "content-wrapper" };
const _sfc_main = {
  __name: "App",
  setup(__props) {
    const personName = /* @__PURE__ */ ref("DEAR FRIEND");
    onMounted(() => {
      const params = getUrlParams();
      if (params.name) {
        personName.value = params.name.toUpperCase();
      }
    });
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createVNode(AnimatedBackground),
        createVNode(ParticleField),
        createBaseVNode("div", _hoisted_2, [
          createVNode(AnimatedCrescent),
          createVNode(EidGreeting, { name: personName.value }, null, 8, ["name"]),
          createVNode(PersonalMessage, { name: personName.value }, null, 8, ["name"])
        ])
      ]);
    };
  }
};
const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-733f5ff2"]]);
